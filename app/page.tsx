...
export default function Home() {
  ...
  const fetchLinks = async () => {
    try {
      ...
      // Filtruj linki bez promptów
      const filteredLinks = data.filter((link: LinkType) => !link.prompt);
      ...
      const errorMessage = error instanceof Error ? error.message : 'Nie udało się pobrać linków';
